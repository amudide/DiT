...
commands = [
    f"python sample_vanilla.py --image-size 256 --device 7 --seed {i}" for i in range(1, 11)
]

#commands = [
#    f"python sample_cfg.py --image-size 256 --device 6 --cfg-scale 1.25" --seed {i}" for i in range(1, 11)
#]
